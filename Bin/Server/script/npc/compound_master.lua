...
function ExeCompoundForge()
    ...
    Msg2Player("[LUA DEBUG] Deleting source items BEFORE creating purple item")
    Msg2Player("[LUA DEBUG] About to delete nEquipIdx=" .. nEquipIdx .. ", nCrystalIdx=" .. nCrystalIdx)

    DelItemByIndex(nEquipIdx)   -- Delete equipment
    DelItemByIndex(nCrystalIdx) -- Delete crystal

    Msg2Player("[LUA DEBUG] Source items deleted successfully")
    ...
    Msg2Player("[LUA DEBUG] Now creating purple item: Detail=" .. nDetail .. ", Parti=" .. nParti .. ", Level=" .. nLevel .. ", Series=" .. nSeries)
    local nPurpleIdx = AddItemPurple(nDetail, nParti, nLevel, nSeries)
    Msg2Player("[LUA DEBUG] AddItemPurple returned: nPurpleIdx=" .. tostring(nPurpleIdx))

    if not nPurpleIdx or nPurpleIdx <= 0 then
        Msg2Player("[LUA DEBUG] ERROR: AddItemPurple FAILED! nPurpleIdx=" .. tostring(nPurpleIdx))
        Talk(1, "", "<color=red>Loi: Khong the tao trang bi tim!<color>")
        return
    end

    Msg2Player("[LUA DEBUG] Purple item created successfully!")
