-- Chung Nho Nguyen Thach (Detail 151) - Thuoc tinh an 3
...
function OnUse(nIdx)
    ...
    -- Use slot 5 for detail 151 (hidden attribute 3)
    local nOp, nValue, nValueMin, nValueMax = GetItemMagicAttribInfo(nIdx, 5)
    ...
    szMsg = szMsg .. "\n<color=cyan>Loai khoang thach:<color> <color=yellow>Thuoc tinh an 3<color>"
