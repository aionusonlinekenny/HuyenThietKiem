-- Mat Ngan Nguyen Khoang (Detail 148) - Thuoc tinh hien 2
...
function OnUse(nIdx)
    ...
    -- Use slot 2 for detail 148 (visible attribute 2)
    local nOp, nValue, nValueMin, nValueMax = GetItemMagicAttribInfo(nIdx, 2)
