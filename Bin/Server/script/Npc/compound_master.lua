...
function ExeCompoundForge()
    ...
    -- CRITICAL: Use genre=1 (item_purpleequip) so save/load works correctly
    -- luck = 1000000000 encodes empty slots 3,4,5
    -- randomSeed = 1000000000 encodes empty slots 0,1,2
    local nPurpleIdx = AddItemEx(
        1,           -- genre = 1 (item_purpleequip) - MUST be purple for save/load
