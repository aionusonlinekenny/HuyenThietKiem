...
function PerformUpgrade(nAttribSlotStr, _)
    -- MINIMAL TEST: Just show dialog, do NOTHING else
    Talk(1, "", "=== PERFORMUPGRADE CALLED ===")
    Talk(1, "", "Param: " .. tostring(nAttribSlotStr))

    -- DO NOTHING - just return to prevent crash
    -- This is a test to see if function is called AT ALL
    return
end
