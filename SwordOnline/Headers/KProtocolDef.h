...
#define KPROTOCOL_VERSION   159

#define CHECK_PASSWORD		2144042
#define LINE_GS 			1089363405
#define LINE_HW				1372236078
#define LINE_MCID			1290599398
#define	LINE_MAC			980564499
/*
 *
 */
...
enum s2c_PROTOCOL
{
	...
	s2c_playerridesync,
	s2c_bloodsync,
	s2c_refeshplayersync,
	s2c_itemchangeinfosync,
	s2c_masklocksync,
	s2c_viewshop,
	s2c_playerautodoskill,
	s2c_npcrandmove,
	s2c_autoplay,//AutoAI by kinnox;
	s2c_lockplayer,//LockPlayer by kinnox;
	s2c_syncreposiplayer,//load 3 storebox by kinnox;
	s2c_syncexpandplayer,//Expandbox by kinnox;
	s2c_opengivebox, //GiveBox by kinnox;
	s2c_openrewardbox, //Reward by kinnox;
	s2c_timebox,//TimeBox by kinnox;
	s2c_playerpointsync,//Syncpoint by kinnox;
	s2c_playersendtoptknew,//Report Battle by kinnox;
...
//	c2s_gmlogin,
	...
	c2s_viewshop,
	c2s_buyplayershop,
	c2s_autoplay, //AutoAI by kinnox;
	c2s_aibacktotown,//AutoAI by kinnox;
	c2s_crepwbox,//LockPlayer by kinnox;
	c2s_loginpwbox,//LockPlayer by kinnox;
	c2s_chapwbox,//LockPlayer by kinnox;
	c2s_lockpwbox,//LockPlayer by kinnox;
	c2s_giverboxscript,//GiveBox by kinnox;
	c2s_giverboxcmd,//GiveBox by kinnox;	
	c2s_rewardscript,//Reward by kinnox;
	c2s_timeboxscript, //TimeBox by kinnox;
	c2s_topbattle,//Report Battle by kinnox;
...
enum
{
	...
	enumTONG_COMMAND_ID_APPLY_CHANGE_MEMBER_TITLE,
	enumTONG_COMMAND_ID_APPLY_CHANGE_ONE_TITLE,
	enumTONG_COMMAND_ID_APPLY_SAVE_MONEY,
	enumTONG_COMMAND_ID_APPLY_GET_MONEY,
