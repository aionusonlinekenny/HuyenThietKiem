...
void KUiStatus::OnDirectAddPoint(int nResultParam)
{
	...
	if(nResultParam == WAIT_UP_STRENGHT){
		KUiGetNumber::OpenWindow("N�ng S�c M�nh", Point, 250, this, nResultParam);
		...
		KUiGetNumber::OpenWindow("N�ng Sinh Kh�", Point, 250, this, nResultParam);
	}else if(nResultParam == WAIT_UP_ENERGY){
		KUiGetNumber::OpenWindow("N�ng N�i C�ng", Point, 250, this, nResultParam);
	}
...
UISYS_STATUS eStatus = g_UiBase.GetStatus();
	...
	{
		UIMessageBox("C�c h� ch�a thi�t l�p m�t kh�u b�o v� nh�n v�t!",this,"Tho�t");
	}
}
