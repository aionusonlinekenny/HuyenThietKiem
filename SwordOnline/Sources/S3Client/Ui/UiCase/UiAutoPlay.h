...
private:
	...
	KWndText80			t_LifeGuide;
	KWndText80			t_TownPortalGuide;
	KWndButton			m_LifeCK;
...
private:
	KWndImage	m_BgPick;
	KWndText32	t_PickGuild;
	KWndText32	t_PickPriceItemsTxt;
	KWndText32	t_PickLevelItemsTxt;
	KWndText32	t_PickJewelryTxt;
...
private: 
	KWndText80			t_FightGuild;
	KWndText80			t_FightSkillGuild;
	KWndText80			t_FightEmiGuild;
	KWndText80			t_FightMenuSuportLight1Txt;
	KWndText80			t_FightMenuSuportLight2Txt;
	KWndImage			m_BgFight;
	...
	KWndText32			t_FightFollowTarget;		
...
private: 
	...
	KWndText80	t_OtherPartyGuide;
	KWndText80	t_OtherOptimalGuide;
	KWndText80	t_OtherOptimalNpcTxt;
	KWndText80	t_OtherOptimalPlayerTxt;
	KWndText80	t_OtherOptimalAniTxt;
...
private: 
	...
	int		WndProc(unsigned int uMsg, unsigned int uParam, int nParam); 
	void	OnCheckInput();
	void 	PopupSelMapTrain();
	void 	SetPortalMapTrain(int nSel);
...
private:
	...
	KWndText32			t_CombackMap;
	KWndLabeledButton	p_CombackMap;
	KWndText80			t_NameComBackMap;	
	int 				m_nSelMapTrain;
};
