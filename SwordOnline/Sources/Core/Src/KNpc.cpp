...
BOOL KNpc::ProcessState()
{
	...
	// FIX: Add periodic position broadcast during movement to eliminate lag
	// Old behavior: Position only broadcast at movement start/stop -> 5-10s lag
	// New behavior: Broadcast position every 5 frames (~50ms) while moving
	if(!(m_LoopFrames % 5))
	{
