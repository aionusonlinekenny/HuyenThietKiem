...
#define		defPLAYER_LOGIN_TIMEOUT			40 * 18		// Increased from 5*18 (90 ticks ~4.5s) to 40*18 (720 ticks ~36s) to prevent timeout during cross-GS transfer and slow character loading
