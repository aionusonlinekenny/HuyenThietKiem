...
xdata$x	SEGMENT
$T94012	DD	019930520H
	DD	02H
	DD	FLAT:$T94015
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T94015	DD	0ffffffffH
	DD	FLAT:$L93946
	DD	00H
	DD	FLAT:$L93947
xdata$x	ENDS
...
xdata$x	SEGMENT
$T94336	DD	019930520H
	DD	02H
	DD	FLAT:$T94339
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T94339	DD	0ffffffffH
	DD	FLAT:$L94024
	DD	00H
	DD	FLAT:$L94025
xdata$x	ENDS
...
; File D:\HuyenThietKiem\SwordOnline\Sources\Core\Src\Scene\KIpoTree.cpp
xdata$x	SEGMENT
$T94836	DD	019930520H
	DD	01H
	DD	FLAT:$T94838
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
$T94838	DD	0ffffffffH
	DD	FLAT:$L94834
xdata$x	ENDS
;	COMDAT ?AddBranch@KIpoTree@@QAEXPAUKIpotBuildinObj@@@Z
_TEXT	SEGMENT
...
; 177  : 		m_pMainBranch = new KIpotBranch;
	...
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T94831[esp+16], eax
	test	eax, eax
...
text$x	SEGMENT
$L94834:
	mov	eax, DWORD PTR $T94831[ebp-4]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
$L94837:
	mov	eax, OFFSET FLAT:$T94836
	jmp	___CxxFrameHandler
text$x	ENDS
...
; 246  : 				CoreGetGameObjLightInfo(pRtoLeaf->uGenre, pRtoLeaf->nId, &lightInfo);
	...
	lea	eax, DWORD PTR _lightInfo$92257[esp+40]
	push	ebp
	push	eax
	push	ecx
	push	edx
...
; 247  : 				pLight->m_dwColor = lightInfo.dwColor;
	...
	mov	eax, DWORD PTR _lightInfo$92257[esp+68]

; 248  : 				pLight->m_oPosition = lightInfo.oPosition;

	mov	edx, DWORD PTR _lightInfo$92257[esp+56]
	lea	ecx, DWORD PTR [esi+8]
	mov	DWORD PTR [esi+20], eax
	mov	eax, DWORD PTR _lightInfo$92257[esp+60]
...
; 250  : 				pLight->m_pParent = pLeaf;
	...
	mov	DWORD PTR [ecx], edx
	mov	edx, DWORD PTR _lightInfo$92257[esp+64]
	add	esp, 12					; 0000000cH
...
; 266  : 						if(m_nCurrentTime >= 480 && m_nCurrentTime <= 960)
	...
	mov	DWORD PTR _n$92263[esp+40], eax
	jl	SHORT $L95291
...
; 280  : 							n = 360;
	...
	mov	DWORD PTR _n$92263[esp+40], 360		; 00000168H
$L92268:

; 281  : 						float f = n / 360.0f;

	fild	DWORD PTR _n$92263[esp+40]
...
; 285  : 						color.Scale(f);
	...
	call	__ftol
	mov	WORD PTR _color$92270[esp+44], ax
	mov	WORD PTR _color$92270[esp+46], ax
	mov	WORD PTR _color$92270[esp+48], ax

; 286  : 						pLight->m_dwColor = color.GetColor();

	mov	eax, DWORD PTR _color$92270[esp+44]
	mov	ecx, DWORD PTR _color$92270[esp+46]
	mov	edx, DWORD PTR _color$92270[esp+48]
...
_this$ = -92
_i$ = -24
_nLightPosX$92445 = -32
_nLightPosY$92446 = -36
_ur$92453 = -52
_ug$92454 = -48
_ub$92455 = -44
_j$92456 = -96
...
; 978  : 		int nLightPosY = pLight->m_oPosition.nY - m_nLeftTopY;
	...
	sub	eax, edi
	sub	ecx, edx
	mov	DWORD PTR _nLightPosX$92445[esp+112], eax
	mov	DWORD PTR _nLightPosY$92446[esp+112], ecx
...
; 1001 :         float fLightRadiusDenom =  1.0 / ((float)pLight->m_nRadius);
	...
	mov	DWORD PTR _ur$92453[esp+112], edx
	mov	edx, eax
	shr	eax, 2
	shr	edx, 10					; 0000000aH
	and	eax, 63					; 0000003fH
	and	edx, 63					; 0000003fH
	mov	DWORD PTR _ub$92455[esp+112], eax
	mov	eax, ebp
	mov	DWORD PTR _ug$92454[esp+112], edx
	mov	ebx, ecx
	cdq
	and	edx, 31					; 0000001fH
	add	eax, edx
...
; 1009 : 		for(int r = 0; r < nGridRadius; r++)
	...
	test	eax, eax
	fstp	DWORD PTR _fLightRadiusDenom$92462[esp+112]
	jle	$L95651
...
; 1015 : 			)
	...
	test	eax, eax
	mov	DWORD PTR _gx$92459[esp+112], eax
	jl	$L95648
...
; 1020 : 				for(j=0; j<(r * 2 + 1); j++)
	...
	mov	DWORD PTR _j$92456[esp+112], 0
...
; 1022 : 					if(CanLighting(x, y, nLightPosX, nLightPosY))
	...
	mov	ebp, DWORD PTR _nLightPosY$92446[esp+112]
	mov	ebx, DWORD PTR _nLightPosX$92445[esp+112]
...
; 1041 : 						uDistance65536 = (int)(f);
	...
	fsqrt
	fmul	DWORD PTR _fLightRadiusDenom$92462[esp+112]
...
; 1046 : 							pCurPos->g += (ug * uDistance65536 / 65536);
	...
	mov	ecx, eax
	imul	edx, DWORD PTR _ur$92453[esp+112]
	imul	ecx, DWORD PTR _ug$92454[esp+112]

; 1047 : 							pCurPos->b += (ub * uDistance65536 / 65536);

	imul	eax, DWORD PTR _ub$92455[esp+112]
...
; 1051 : 					gx++;
	...
	mov	eax, DWORD PTR _gx$92459[esp+112]
	inc	eax
...
; 1052 :                     if (gx >= LIGHTING_GRID_WIDTH)
	...
	mov	eax, DWORD PTR _j$92456[esp+112]
...
; 1056 : 					pCurPos++;
	...
	lea	ecx, DWORD PTR [edx+2]
	cmp	eax, ecx
	mov	DWORD PTR _j$92456[esp+112], eax
	jl	$L92471
$L95640:
...
; 1071 : 				pCurPos = &pLColor[gy * LIGHTING_GRID_WIDTH + gx];
	...
	mov	esi, DWORD PTR _this$[esp+112]
	mov	DWORD PTR _y$92458[esp+112], ecx
...
; 1074 : 					if(CanLighting(x, y, nLightPosX, nLightPosY))
	...
	mov	edx, DWORD PTR _y$92458[esp+112]
	mov	ecx, DWORD PTR _this$[esp+112]
	push	ebp
	push	ebx
	push	edx
...
; 1091 : 						));
	...
	mov	eax, DWORD PTR _y$92458[esp+112]
	mov	ecx, edi
	sub	ecx, ebx
	sub	eax, ebp
	mov	edx, ecx
...
; 1116 : 			)
	...
	test	eax, eax
	mov	DWORD PTR _gy$92460[esp+112], ecx
	jl	$L95623
	test	ecx, ecx
	jl	$L95623
...
; 1152 : 					gy++;
	...
	mov	eax, DWORD PTR _gy$92460[esp+112]
	inc	eax

; 1153 :                     if (gy >= LIGHTING_GRID_HEIGHT)

	cmp	eax, 96					; 00000060H
	mov	DWORD PTR _gy$92460[esp+112], eax
	jge	SHORT $L95642
	mov	eax, DWORD PTR _j$92456[esp+112]
...
; 1166 : 			)
	...
	mov	DWORD PTR _gy$92460[esp+112], esi
	jge	$L92468
	test	esi, esi
	jl	$L92468
